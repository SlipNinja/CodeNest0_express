...
export default class Course {
	...
	static async get_all_for_user(id_user) {
		const sql = `SELECT courses.id_course, name, logo, level, description, programming_language, number_step, (number_step = last_finished_step) AS completed FROM courses
